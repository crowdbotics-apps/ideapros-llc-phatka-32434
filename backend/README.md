...
## Project Structure
    ...
    ├── ideapros_llc_phatka_32434  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_phatka_32434`
...
2. Clone this repo and `cd ideapros_llc_phatka_32434`
